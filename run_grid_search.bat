...
:: ==========================================
:: set MODELS=EASE RLAE DLAE LAE DAN_EASE DAN_RLAE DAN_DLAE DAN_LAE ASPIRE_RLAE ASPIRE_EASE ASPIRE_DLAE ASPIRE_LAE IPS_LAE IPS_EASE IPS_RLAE IPS_DLAE
set MODELS=IPS_LAE IPS_EASE IPS_RLAE IPS_DLAE
:: Datasets to run
set DATASETS=steam
